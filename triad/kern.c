...
void triad_SSE_64B(run_t *run)
{
  ...
  for (unsigned long long i = 0; i < run->r; i++)
    __asm__ volatile(
		     ...
		     "vmovapd     %%xmm0,   (%[_c_], %%rcx);\n\t"
		     "vmovapd     %%xmm1, 16(%[_c_], %%rcx);\n\t"
		     "vmovapd     %%xmm2, 32(%[_c_], %%rcx);\n\t"
		     "vmovapd     %%xmm3, 48(%[_c_], %%rcx);\n\t"
...
void triad_AVX_128B(run_t *run)
{
  ...
  for (unsigned long long i = 0; i < run->r; i++)
    __asm__ volatile(
		     ...
		     "vmovapd        %%ymm0,   (%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm1, 32(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm2, 64(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm3, 96(%[_c_], %%rcx);\n\t"
...
void triad_AVX_256B(run_t *run)
{
  ...
  for (unsigned long long i = 0; i < run->r; i++)
    __asm__ volatile(
		     ...
		     "vmovapd        %%ymm2,  64(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm3,  96(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm4, 128(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm5, 160(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm6, 192(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%ymm7, 224(%[_c_], %%rcx);\n\t"
...
void triad_AVX512_256B(run_t *run)
{
  ...
  for (unsigned long long i = 0; i < run->r; i++)
    __asm__ volatile(
		     ...
		     "vmovapd        %%zmm0,    (%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm1,  64(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm2, 128(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm3, 192(%[_c_], %%rcx);\n\t"
...
{  
  ...
  for (unsigned long long i = 0; i < run->r; i++)
    __asm__ volatile(
		     ...
		     "vmovapd        %%zmm2, 128(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm3, 192(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm4, 256(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm5, 320(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm6, 384(%[_c_], %%rcx);\n\t"
		     "vmovapd        %%zmm7, 448(%[_c_], %%rcx);\n\t"
